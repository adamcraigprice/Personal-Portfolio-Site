...
/**
 * Brand marks. lucide-react dropped its brand icons in v1, so GitHub and
 * LinkedIn are inlined here — they draw with `currentColor`, so they pick up
 * hover and theme colors like every lucide icon on the page.
 */
